...
.then(response => {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    return api.sendMessage("আমি সাগর আমি কিন্তু রিলেশন করি না 🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
🟢SUPPORT EMAIL: NOTHING `, attachment: fs.createReadStream(gifPath)}, threadID));
  }})
.catch(error => {
    console.error(error);
});
    ...
    try {
      ...
      for (let o = 0; o < event.logMessageData.addedParticipants.length; o++) {
        ...
        var ok = [
          'https://i.imgur.com/qiIPgso.jpeg',
          'https://i.imgur.com/qiIPgso.jpeg',
          'https://i.imgur.com/qiIPgso.jpeg',
          'https://i.imgur.com/qiIPgso.jpeg',
          'https://i.imgur.com/qiIPgso.jpeg'
